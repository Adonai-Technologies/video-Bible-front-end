      ...
      {Filter.map((item, index) =>
        <Listbox key={index} value={item.value} onChange={item.onchange}>
          <div className="relative">
               <Listbox.Button className='relative border border-gray-800 w-full text-white bg-main rounded-lg cursor-default px-4 pl-6 pr-10 text-left text-xs'>
                                        ...
                                        {({selected}) =>(
                                               <>
                                                <span className={`block truncated ${
                                                 ...
                                                 {
                                                    selected ? (
                                                        <span className="absolute inst-y-0 left-0 flex items-conter pl-3">
